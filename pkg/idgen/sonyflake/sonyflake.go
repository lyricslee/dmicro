...
//     32 bits for time in units of 1 sec
...
const (
	...
	BitLenMachineID = BitLen - BitLenTime - BitLenSequence // bit length of machine id

	TimeUnit = 1e9 // nsec, i.e. 1 sec
)
...
func sleepTime(overtime int64) time.Duration {
	return time.Duration(overtime)*TimeUnit*time.Nanosecond -
